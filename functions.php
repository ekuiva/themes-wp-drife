...
function main_init_js(){
	...
	///wp_enqueue_style('flexslider-css', get_template_directory_uri().'/library/css/flexslider.css', false, '3', 'all' );
	...
	// wp_enqueue_script('flexslider-js', get_template_directory_uri().'/library/js/jquery.flexslider.js', array('jquery'), '3',true);
